<template>
	<form class="new_guest" id="new_guest" accept-charset="UTF-8" :model="guest" v-on:submit.prevent="onSubmit" autocomplete="off">
		...
		<div class="form-group session__field">
			<b-form-input autocomplete="off" placeholder="Mot de passe du Faire-part ou du groupe Facebook" class="form-control" required="required" type="password" v-model="guest.password"></b-form-input>
		</div>
		<div class="row no-gutters justify-content-between mt-4">
			<div class="form-group session__field">
				<div class="custom-control custom-checkbox">
					<input name="guest[relist_me]" type="hidden" value="0" />
					<input class="custom-control-input" type="checkbox" value="1" name="guest[relist_me]" id="guest_relist_me" />
	...
	<div class="session__switch mb-4">
		...
		<a class="session__link sign-up-link" href="mailto:gautier.morel@gmail.com">Demande de compte</a>
	</div>

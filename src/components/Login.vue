  ...
  <div class="container">
    <div class="row justify-content-center my-basis">
      <div class="col-md-5 px-4">
        <div class="session__or">
          <span>Découvrez votre espace invité !</span>
        </div>
        <form
          class="new_guest"
          id="new_guest"
        ...
        >
          <div class="form-group session__field">
            <SearchForm class="form-control" @selected="setGuestId" />
          </div>
          <div class="form-group session__field">
            <b-form-input
            ...
            <div class="form-group session__field">
              <div class="custom-control custom-checkbox">
                ...
                <input
                  ...
                  id="guest_relist_me"
                />
                <label class="custom-control-label" for="guest_relist_me"
                  >Se souvenir de moi</label
                >
              </div>
            </div>
            <div class="form-group session__field">
              <a class="session__link" href="mailto:gautier.morel@gmail.com"
        ...
        <div class="session__switch mb-4">
          ...
          <a
            ...
            href="mailto:gautier.morel@gmail.com"
            >Demande de compte</a
          >
        </div>
